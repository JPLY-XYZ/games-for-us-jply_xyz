...
function Guardados() {
  ...
  return (
    <div className="flex flex-col h-full flex-initial grow self-start  overflow-hidden">
      <div>
        <div className="bg-[var(--header-footer-background)] px-6 py-2 md:flex">
          <form
          ...
          >
            ...
            <button
              class="cursor-pointer inline-flex items-center py-2.5 px-3 ms-2 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
              type="submit"
            >
              <svg
                viewBox="0 0 20 20"
