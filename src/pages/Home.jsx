...
function Home() {
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      <div>
        <div
          className="group  overflow-hidden relative shadow-lg max-w-xs"
        >
          ...
          <div className="absolute bg-black flex items-center group-hover:-top-0 group-hover:opacity-100 duration-700 top-full right-0 w-full opacity-0 h-1/2 transition-all">
            <div
              className=""
              style={{backgroundImage: 'url("https://cdn.cloudflare.steamstatic.com/steam/apps/230410/ss_2d79448091149a8cc790b62e7422615a011d015a.600x338.jpg?t=1637183731")'}}
            >
              <video
                className="w-full"
                autoplay
          ...
          >
            <div className="py-4 text-xs px-7">
              ...
              <div className="overflow-ellipsis overflow-hidden whitespace-nowrap">
                ...
                <span className="whitespace-nowrap overflow-hidden overflow-ellipsis relative z-20">
                  <a href="https://store.steampowered.com/developer/DigitalExtremes?snr=1_4_600__629">
                    Digital Extremes
                  </a>{" "}
                </span>
              </div>
              <div className="whitespace-nowrap overflow-hidden overflow-ellipsis relative z-20">
                ...
                <span className="whitespace-nowrap overflow-hidden overflow-ellipsis relative z-20">
                  <a href="https://store.steampowered.com/publisher/DigitalExtremes?snr=1_4_600__629">
                    Digital Extremes
                  </a>{" "}
                </span>
              </div>
            ...
            <div className="absolute left-0  pl-7 pt-1">
              <button
                ...
                className="px-4 text-base block text-green-300 rounded-sm border-2 border-opacity-20 bg-gradient-to-b duration-700 from-green-400 to-green-800"
              >
                Install now
              </button>
            </div>
